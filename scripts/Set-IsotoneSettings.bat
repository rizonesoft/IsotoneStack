@echo off
REM Set-IsotoneSettings.bat
REM Launcher for Set-IsotoneSettings.ps1
REM Manages IsotoneStack settings configuration
...
set "PS1_SCRIPT=%SCRIPT_DIR%\Set-IsotoneSettings.ps1"
