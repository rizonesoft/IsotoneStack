@echo off
REM Update-ScriptLogging.bat
REM Launcher for Update-ScriptLogging.ps1
REM Updates all scripts to use optimized logging
...
set "PS1_SCRIPT=%SCRIPT_DIR%\Update-ScriptLogging.ps1"
...
echo Running Script Logging Update...
