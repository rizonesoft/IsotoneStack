@echo off
REM ==================================================================
REM Configure-Chromium.bat - Configure Chromium browser settings
REM Disables sign-in, sync, and other features for privacy
REM ==================================================================
title Configure Chromium - IsotoneStack
