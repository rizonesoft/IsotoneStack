@echo off
REM ==================================================================
REM Install-DevDependencies.bat - Install Python development dependencies
REM Located in scripts/python for better organization
REM ==================================================================
title Install Dev Dependencies - IsotoneStack Control Panel
...
REM Keep window open on error or success for user to see results
if %errorlevel% neq 0 (
    echo.
    ...
    echo Run with --category [name] to install specific tools
    echo.
    pause
)